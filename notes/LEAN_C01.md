# External Lean formalization of C01
...
This formalization covers the determinant and collision at the core of C01.
It does not formalize this repository's inverse geometry (C02--C03), weighted
families (C04 onward), or the stable reductions in C15.
...
`.cache/lean-c01`, downloads the Lean/mathlib cache declared by that project,
