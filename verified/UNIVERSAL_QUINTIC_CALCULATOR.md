...
| \(D_5\) | \([10:4:-21:20]\) | 21 | \(32S^5-6250S^3+13125S^2+12500S-12500\) | 13125 | \(\Delta=(2040064/78125)^2\); \(R_{10}=R_5R'_5\), both \(3:(5)\); \(11:(2,2,1)\) | 10 |
...
single out \(A_5\).  Two five-element orbits on unordered pairs leave
\(C_5\) or \(D_5\), and a \((2,2,1)\)-element selects \(D_5\).  An
...
Its pair-sum resolvent is

\[
\frac{
(3125X^5-28750X^3-2000X^2+62725X+4784)
(3125X^5-18125X^3+7250X^2+2500X-776)}
{9765625},
\]

where the displayed juxtaposition means the product of the two parenthesized
quintics.  Both are irreducible modulo \(3\).
