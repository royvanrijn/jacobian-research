...
- `elkies-k3-curve398-11952-norm8-a1-modular-screen-v1.json` compacts the
  ...
  second pencil and its 180-element degree-one shell, specializes a saturated
  MW16 basis, and proves by determinant-one transitions that both specialized
  integral subgroups are equal.  Their sum has rank 16, with quotient `Z^14`
  and infinite index in public `M30`; its SHA-256 is
  `151049222e552705508efb7cd03844d1eaf627fe29908f01fcee4b2d27bd3ea8`.
...
- `elkies-k3-icarm-11952-norm8-a1-mw16-atlas-v1.json` compacts the complete
  63,917-class A1/MW16 screens for eleven priority ICARM targets (703,087
  target--fibration pairs), exact survivor factorizations, and nine compiled
  pencils on five target curves.  Replay with
  `python3 elkies-k3/scripts/build_icarm_a1_mw16_atlas.py --check`; its
  SHA-256 is `f73088926de9e5ed5236523bec504c3dbf76bdbf65ae14f86a0830bc2eac82e6`.
