...
- **P0**: combined interval `[20,20]`; this externally certifies exact rank 20.
- **P2**: interval `[20,R]` with `R>20`; 2-descent still leaves residual room.
...
Its advantage is that it is free, accepts the known points directly, and PARI's
rank upper bound already incorporates the Cassels-pairing restriction. If P2
