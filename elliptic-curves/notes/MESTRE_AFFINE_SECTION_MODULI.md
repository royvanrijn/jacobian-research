...
The selected sections meet at the finite quartic point
`T=-4223/544`, `(x,y)=(4417/544,63251685/544)`; this is only a preliminary
intersection datum.
...
to 11 (and adjoining all eight still has rank 11).  This is a valid
finite-specialization visible-subgroup escape for the exact component and
rules out the selected points being merely specialized visible combinations
at those fibres.  It does not separate the two new points from each other,
prove generic rank at least 14, establish saturation, or determine a Shioda
