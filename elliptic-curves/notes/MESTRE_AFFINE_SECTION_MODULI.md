...
leading invariant is a rational square and that the selected pair is
generically dependent modulo the visible Mestre sections.
...
is now explained by the generic relation on the recovered surface: the
missing pivot is structural, not a weakness of the chosen quotient panel.
...
two-dimensional moduli surface and its selected generic relation.  Neither
...
that the selected pair cannot provide the missing generic rank-14 direction.
