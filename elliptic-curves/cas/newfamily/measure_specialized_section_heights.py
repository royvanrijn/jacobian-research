...
def run_parent(args):
    ...
    print(json.dumps({
        ...
        "output": str(out),
        "minimum_known_naive_height": min((r["known_naive_min"] for r in done), default=None),
        "median_of_minima": sorted((r["known_naive_min"] for r in done))[len(done)//2] if done else None,
