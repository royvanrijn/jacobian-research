...
D=ROOT/'artifacts/local/elliptic-curves/compact192-followup-supplement-portable-v1'
OUT=ART/'compact192_followup_supplement_portable_replay_v1.json'
SAGE='/home/royvanrijn/.local/share/jacobian-sage-10.9/bin/python'

def main():
    path=ART/'compact192_followup_supplement_evidence_v1.json';manifest=cert.read(path);workspace=D/'workspace';folder=D/'verification'
    ...
    checkpoint(OUT,{'schema':'elliptic-curves.compact192-followup-supplement-portable-replay.v1','status':'PASS','logical_stages':len(jobs),
