...
BATCH=LOCAL/'retained-native19-point-trial-v2';INDEX=ART/'new_high_rank_curve_index_v22.json';GATE=ART/'inventory188_fixed49_point_control_v1.json'
...
def sources():
    names=['audit_retained_native19_trial_v2.py','replay_retained_native19_geometry_v2.sage','export_new_high_rank_curve_index_v14.py','memory_rank_certificate.py','retained_native19_trial_v2.py','prepare_retained_native19_trial_v2.sage','prepare_fresh_r17_pari_batch.sage','fresh_r17_pari_batch.py','prospective_half_lattice_v2.sage','prospective_half_lattice_v3.sage','research_runtime/floating_norm_check.py','research_runtime/search_state.py','research_runtime/preloaded_prime_state.py','research_runtime/rotated_observation_state.py','research_runtime/cached_observation_state.py','research_runtime/pointed_orbit_compression.py','research_runtime/quotient_only_reduction.py','research_runtime/supervisor.py','replay_retention24_geometry.py','audit_recent_outer26_exposure.py','score_retained_native19.py','audit_retained_native19_intake.py']
...
def launch():
    ...
    for index in range(len(p['rows'])):
        ...
        s=supervise(['/home/royvanrijn/.local/share/jacobian-sage-10.9/bin/python',str(CAS/'prepare_retained_native19_trial_v2.sage'),'--index',str(index)],limits=Limits(p['geometry_wall_seconds'],p['rss_bytes']),log_path=D/(name+'.log'),checkpoint_path=path,cwd=ROOT)
