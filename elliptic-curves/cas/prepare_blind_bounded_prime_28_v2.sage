...
import blind_bounded_prime_28_control_v2 as control
...
mapper=SourceFileLoader('bounded_prime_mapping',str(CAS/'bounded_prime_pari_mapping_v2.sage')).load_module()
