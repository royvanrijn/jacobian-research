...
import compact192_specialized_followup as control
...
def main():
    ...
    cloud_check(data,data['charts'],control.ART/('compact192_specialized_'+control.ROW['id'].split('-')[-1]+'_mod2_v1.json'),D/'result.json')
