...
D=LOCAL/'nearcut60-mw16-pari-v1'
ART=ROOT/'artifacts/generated-results/elliptic-curves'
REPORT=ART/'nearcut60_mw16_experiment_v1.json'
OUT=ART/'nearcut60_mw16_accounting_replay_v1.json'
...
def audit():
    ...
    return {'schema':'elliptic-curves.nearcut60-independent-accounting.v1','status':'PASS','sources':bindings,
