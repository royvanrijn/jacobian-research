...
import full11952_specialized_followup as control
...
def main():
    ...
    cloud_check(data,data['charts'],control.ART/('full11952_specialized_'+control.ROW['id'].split('-')[-1]+'_mod2_v1.json'),D/'result.json')
