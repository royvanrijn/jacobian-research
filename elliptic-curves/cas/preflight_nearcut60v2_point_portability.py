...
ROOT=batch.ROOT;CAS=batch.CAS;D=batch.extension.D/'portability-preflight-v2'
OUT=batch.ART/'nearcut60v2_mw16_portability_preflight_v1.json'
...
def main():
    ...
    paths.update([batch.D/'protocol.json',batch.extension.OUT,batch.extension.D/'protocol.json',
        batch.extension.D/'controller/ledger.json',CAS/'verify_nearcut60v2_mw16_points.py',
        CAS/'package_nearcut60v2_mw16_points.py',CAS/'verify_nearcut60v2_mw16_points_portable.py'])
    ...
    checkpoint(OUT,{'schema':'elliptic-curves.nearcut60v2-portability-preflight.v1','status':'PASS',
    ...
    print('NEARCUT60V2 PROSPECTIVE PORTABILITY PREFLIGHT PASS',len(paths),'FILES',flush=True)
