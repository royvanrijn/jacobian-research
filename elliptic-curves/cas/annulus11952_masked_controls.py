...
ROOT=Path(__file__).resolve().parents[2];CAS=ROOT/'elliptic-curves/cas';ART=ROOT/'artifacts/generated-results/elliptic-curves';LOCAL=ROOT/'artifacts/local/elliptic-curves';D=LOCAL/'annulus11952-masked-controls-v1';PARENT=LOCAL/'annulus64-r17-pari-v2';SAGE='/home/royvanrijn/.local/share/jacobian-sage-10.9/bin/python'
def sources():
    names=['annulus11952_masked_controls.py','prepare_annulus11952_masked_controls.sage','run_ordinary_masked_controls.sage','prepare_product24_r17_pari_batch.sage','prospective_half_lattice_v2.sage','search_observability.py','research_runtime/deep_centres.py','research_runtime/search_state.py','research_runtime/finite_reduction.py','research_runtime/memory_store.py']
