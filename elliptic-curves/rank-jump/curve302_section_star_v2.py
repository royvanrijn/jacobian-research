...
INPUT=r.OUT/'rank_jump_curve302_section_star_inputs_v2.json'
OUTPUT=r.OUT/'rank_jump_curve302_section_star_v2.json'
WORK=r.ROOT/'artifacts/local/rank-jump-curve302-section-star-v2'
...
def compute():
    ...
    for n,star in enumerate(d['stars']):
        ...
        ker=mat.right_kernel();record={'star_index':n,'star':star,'quadric_space_dimension':int(ker.dimension())}
