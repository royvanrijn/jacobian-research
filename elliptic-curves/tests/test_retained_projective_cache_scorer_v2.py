...
class RetainedCacheScorer(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        subprocess.run(['g++','-O3','-std=c++17',str(ROOT/'elliptic-curves/cas/newfamily/score_retained_projective_cache_v2.cpp'),'-o',str(cls.binary)],check=True,capture_output=True,timeout=20)
    @classmethod
