...
from search_nagao_rank21_t1637_alternate_covers import (  # noqa: E402
    CERTIFICATE_SHA256,
    PARAMETER_T,
    load_exact_basis,
    sha256_file,
...
CERTIFICATE = GENERATED / "elliptic_nagao_rank21_t1637_rank16_certificate.json"
ARTIFACT = GENERATED / "elliptic_nagao_rank21_t1637_alternate_covers.json"
SCRIPT = CAS / "search_nagao_rank21_t1637_alternate_covers.py"


class NagaoRank21T1637AlternateCoverTests(unittest.TestCase):
    ...
    def test_generated_artifact_is_pinned_when_present(self) -> None:
        ...
        self.assertGreaterEqual(
            data["results"]["certified_rank_lower_bound_after_search"], 16
        )
