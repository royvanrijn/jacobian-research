...
def build_prime(prime):
    ...
    M7, rows7 = block_matrix(("E7",))
    M8H, rows8H = block_matrix(("E8", "H"))
    M7H, rows7H = block_matrix(("E7", "H"))
    ...
    print(
        "Q8GLOBALDIAG|prime={}|ambient={}|"
        "H={}:{}:{}|E8={}:{}:{}|E7={}:{}:{}|"
        "E8H={}:{}:{}|E7H={}:{}:{}|E8E7={}:{}:{}|"
        "ALL={}:{}:{}|status=GLOBAL_Q8_BLOCK_DIAGNOSTIC".format(
            prime, ncols,
            MH.nrows(), rankH, ncols-rankH,
            M8.nrows(), rank8, ncols-rank8,
            M7.nrows(), rank7, ncols-rank7,
            M8H.nrows(), rank8H, ncols-rank8H,
            M7H.nrows(), rank7H, ncols-rank7H,
            M87.nrows(), rank87, ncols-rank87,
