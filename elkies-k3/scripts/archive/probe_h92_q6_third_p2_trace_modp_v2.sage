...
def quartic_pole_points(tau, quartic, covariants, minimizing_unit, child_a, child_b):
...
for tau_integer in tau_candidates:
    try:
        ...
        # Fail early in the base field if the covariant map is wrong.
        u0, pole_points = quartic_pole_points(
            tau, quartic, covariants, minimizing_unit, child_a, child_b
        )
