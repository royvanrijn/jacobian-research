...
# r0 is a denominator after solving P1_1, so stay on the open branch r0 != 0.
...
# Param0 file order: 8 fiber equations, then P1_1,P1_2,P1_3.
y=sd["y1"]; e1=Es[8]
...
# Map S -> T and substitute the exact y1 expression. Denominator is a nonzero field scalar.
...
# P1_2 and P1_3 must be dependent after P1_0 parametrization + P1_1 elimination.
...
if p12!=0 or p13!=0:
    raise RuntimeError("P1_2/P1_3 did not vanish; refusing to solve an inconsistent reduction")
