...
parser.add_argument("--global-sign",type=int,choices=(-1,1),required=True)
...
# ===========================================================================
# Reuse the globally certified QQ(U) square-root orientation.
# ===========================================================================
global_sign=int(args.global_sign)
assert global_sign in (-1,1)
print(
    f"Q24D46DIRECTGLOBAL_ORIENT|scale_root_sign={global_sign:+d}|"
    "criterion=reuse_certified_global_QQ_U_orientation|"
    "status=PASS_REUSED_GLOBAL_SIGN",
    flush=True,
)
...
# ===========================================================================
# Fresh-prime intrinsic verification.
# The independent backtrack artifact stores GF(100003) residues and is not
# a characteristic-zero coefficient source. At fresh primes we rely on
# the exact QQ(U) direct map, coherent samples, and exact Weierstrass identity.
# ===========================================================================
print(
    "Q24D46DIRECTGLOBAL_CROSSCHECK|"
    "source=exact_QQ_U_map_plus_intrinsic_weierstrass_identity|"
    "status=PASS_FRESH_PRIME_INTRINSIC",
    flush=True,
)
...
payload={
    ...
    "independent_crosscheck":{
        ...
        "x_identical":None,
        "y_identical":None,
        "note":"GF(100003)-specific reference intentionally not reused at fresh primes",
    },
    "next":(
...
print(
    ...
    "orientation=REUSED_GLOBAL_QQ_SIGN|status=PASS_MODULAR_Q24_FROM_DIRECT_DEGREE46_BRIDGE",
    flush=True,
)
