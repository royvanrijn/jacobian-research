...
One divisor O+P4+P11 on11952, zero P7. At most64 finite samples at1009,
...
OUT=ROOT/'artifacts/generated-results/elkies-k3-curve302-triangle-mw14-mod1009-v1.json'
LOCAL=ROOT/'artifacts/local/elkies-k3/curve302-a2-mw15'
...
def make_pencil(field):
    ...
    E=EllipticCurve(K,[A,B]);P,Q,Z=[E(rat(d['sections']['records'][i]['X']),rat(d['sections']['records'][i]['Y'])) for i in [3,10,6]]
    def meet_o(P):
...
def build(prime=1009):
    ...
    return {'schema':'curve302.triangle-mw14-modular-probe.v1',
        ...
        'prime':prime,'divisor':'O+P4+P11','zero':'P7','old_degree':3,
...
if __name__=='__main__':
    ...
    OUT=OUT.with_name(f'elkies-k3-curve302-triangle-mw14-mod{args.prime}-v1.json')
