...
through the complete equation-level rootless-bisection injectivity certificate
on 2026-08-31. The
exact equation route reaches the preferred q12/orbit5867 rootless model,
proves its identity with the certified H3 source, establishes geometric
Picard rank 19, and identifies its full saturated geometric Mordell--Weil
lattice with determinant-948 R17. Reverse equation lifting now makes the final
three historical fixed-corridor arrows equation-explicit.  The exact
4A1-to-3A1 horizontal is retained, but its first hand-built marked-node
quotient is rejected by an irreducible genus-two residual. That reverse lift
is parked after preserving its exact checkpoints; endpoint arithmetic now has
priority. The compact published rank-17 chart is identified exactly, its
rank-25--28 fibres are calibrated positive controls, and a fail-closed residual
2-Selmer gate precedes point search. Separately, all 39,120 surviving rootless
bisection classes have distinct explicit quadratic extensions, proving
injectivity of that complete finite map and closing it for rank-two collisions.
q12/orbit4484 remains a certified but unnecessary fallback.
