...
| 08-31 17:30 | complete distinct-extension biquadratic census: Every one of the 39,120 quadratic bisection bases is a rational conic; all primitive branch quadratics are irreducible and pairwise nonproportional. Every distinct pair therefore gives a genus-one V4 base with exact new-section height matrix diag(24,24). The 5,566 bases with an immediate rational point were minimized and root-numbered completely; a bounded exact point ledger found two base Jacobians of rank at least 9. | Exact Hasse--Minkowski solubility, primitive branch comparison, Riemann--Hurwitz, character-orthogonality of canonical heights, binary-quartic invariants, global minimization, conductor/root-number computation, PARI bounded point search and finite-quotient infinite descent. | There are 765,167,640 explicit generic-rank-at-least-19 genus-one base changes. The simplest promoted rank-at-least-nine base has masks 42110:43109; an exact 2-isogeny and pointed-quartic inverse now transport its nine independent points to nine explicit rational `(t,u,v)` points. Both rank-nine leaders and the published pair lie outside the norm-four disjoint graph. | Injectivity obstructs only a shared quadratic extension, not a compositum of distinct extensions. Use Galois characters for independence and retain geometric disjointness graphs as priorities rather than hard filters. | proved complete pair geometry and 5,566-base arithmetic census; explicit base rank at least 9 and effective map to the t-line |
