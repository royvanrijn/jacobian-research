...
- **Complete norm-twelve record-lineage atlas:** all 43 shared-zero degree-two charts are compiled and form six rational-`PGL2` `j`-classes. Curves 273 and 302 miss the complete atlas. One eight-chart published-R17 class contains curves 351, 356, 376, 377, and 385 as untwisted fibres with a saturated common MW17 basis and exact displayed exceptional quotients.
...
- The four published R17 rank-25--28 controls are **not** rational fibres of the alternate chart: their exact alternate `j`-preimage polynomials have no rational roots. A future alternate specialization programme therefore needs native calibration fibres.
...
1. solve the 34 missing published-R17 rational visibility directions by a target-directed inverse problem, without enumerating the ambient trisection or quadrisection cosets;
2. compute the 2-primary coboundary/saturation quotient for the seventeen alternate-Q80 product twists; do not return to the superseded unsliced eight-variable `msolve` campaign;
3. extend the inverse-ADE planner beyond the single curated positive control, only after supplying complete marked route data;
