...
known OP-UG3 reason: `V(h)` is a distinct unramified nonproperness divisor.
...
## 8. Consequences for OP-SUSP and OP-UG3
...
For `OP-UG3`, it proves that failure of `(G)` and the extra unramified
divisor are the same coefficient in this cell, rather than independent
obstructions.
