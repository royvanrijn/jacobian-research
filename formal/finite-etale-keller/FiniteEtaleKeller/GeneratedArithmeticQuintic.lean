...
namespace FiniteEtaleKeller.GeneratedArithmeticQuintic
...
def compiledMap : Fin 3 → GaugePolynomial ℚ :=
  generalGaugeJacobianOneMap compiledSeed
...
def compiledFiberEquiv
    ...
    (AdjoinRoot compiledPolynomial →ₐ[ℚ] A) ≃
      GeneralGaugeJacobianOneFiberPoint
        compiledSeed 1 compiledTargetC A := by
  rw [compiledTargetC_eq]
...
end FiniteEtaleKeller.GeneratedArithmeticQuintic
