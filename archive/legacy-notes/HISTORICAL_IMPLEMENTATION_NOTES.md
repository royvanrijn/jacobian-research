...
> **Archived snapshot.** This is not a current status ledger.  Result status
> and review level are maintained only in [`STATUS.md`](../../STATUS.md).
...
- Archive an environment reproduction log; an independent standard-library
  exact implementation now regenerates both Stable Normal-Form Consequences forms.
