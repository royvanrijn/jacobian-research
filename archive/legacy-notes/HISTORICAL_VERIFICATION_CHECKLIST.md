# Historical verification and research checklist

> **Archived snapshot.** Checked boxes record the state of the earlier proof
> programme and are not current status claims.  See
> [`STATUS.md`](../../STATUS.md) and [`REPRODUCE.md`](../../REPRODUCE.md).
...
- [x] Locate, scope, credit, pin, and reproduce Dean Cureton's external Lean 4
  formalization of the determinant and collision (`make verify-lean-foundational`).
