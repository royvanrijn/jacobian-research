...
PROTOCOL=Path(__file__).with_name('REFERENCE_PARTIAL_CLASS_EXTRACTION_PROTOCOL.json')
RELWORK=r.ROOT/'artifacts/local/rank-jump-seeded-reference-relations-memory-v1'
WORK=r.ROOT/'artifacts/local/rank-jump-reference-partial-class-extraction-v1'
OUTPUT=r.OUT/'rank_jump_reference_partial_class_extraction_v1.json'
ACCEPTED=RELWORK/'accepted-elements.json'
...
def compute():
    ...
    return {'schema':'rank-jump.reference-partial-class-extraction.v1','status':'PASS',
