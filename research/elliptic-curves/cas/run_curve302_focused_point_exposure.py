...
import curve302_focused_point_exposure as batch
...
def main():
    ...
    stage('prepare',[sys.executable,str(batch.CAS/'curve302_focused_point_exposure.py'),'prepare'],120)
    ...
    stage('freeze',[sys.executable,str(batch.CAS/'curve302_focused_point_exposure.py'),'freeze'],60)
    batch.launch()
