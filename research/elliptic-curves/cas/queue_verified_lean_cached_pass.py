...
def record(folder):
    ...
    if (protocol['schema'] not in ('prepared-parent-lean-cached-continuation.v1',) or
    ...
    output = dict(status='QUEUED_NOT_LAUNCHED', rank_lower_bound=terminal['rank_lower_bound'],
                  ...
                  inherited_charts=protocol['inherited_charts'],
                  new_point_invocations=terminal['charts']-protocol['inherited_charts'],
