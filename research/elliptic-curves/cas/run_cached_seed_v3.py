...
def freeze(folder):
    ...
    parent.require(policy['schema'] in ('prepared-parent-short-pass.v1',
                                      'prepared-parent-cached-continuation.v1'),
    ...
    policy.update(schema='prepared-parent-cached-continuation.v1',
...
if __name__ == '__main__':
    ...
    if folder.exists():
        parent.require(parent.read(folder/'protocol.json')['schema'] ==
                       'prepared-parent-cached-continuation.v1', 'not a cached continuation')
