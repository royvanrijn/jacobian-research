#!/usr/bin/env python3
"""Bounded prepared-seed discovery with native productive anchors and two map policies.
...
from visibility_productive92 import landscape
...
def freeze(folder):
    ...
    names = ('run_productive_seed_v3_v2.py', 'visibility_productive92.py',
    ...
    inputs = [seed_path, PREP/'prepared.json', BANK/'anchor-bank.json',
              BANK/'protocol.json', BANK/'gains.json', PREP/'generic-cvp-proofs.json']
    protocol = {'schema': 'prepared-seed-productive-adaptive.v2', 'initial_rank': initial_rank,
        ...
        'selection': 'V3 diversified extension shortlist over every frozen historical productive '
        ...
        'scope': 'New directions beyond the supplied certified native MW16/R17 seed. Historical productive '
