...
DIRECTORY=ROOT/'artifacts/local/elliptic-curves/prospective-mw16-rank25-followup-v1'
...
def prepare(directory):
    ...
    path=PARENT/'a1-fibration-05/candidate-03/result.json';result=cert.read(path)
    certificate=ROOT/'artifacts/generated-results/elliptic-curves/prospective_mw16_results_v1.json'
    ...
    checkpoint(directory/'protocol.json',{'schema':'elliptic-curves.prospective-mw16-rank25-followup.v1','sources':sources(),
        ...
        'selection':'Sole new rank25 result of the completed fixed20-address MW16 pilot; adaptive points are only those discovered and independently certified in that pilot.',
