...
import time
import shutil
from bounded_map_receipts import obtain as obtain_map
...
def freeze(folder):
    ...
    names = ('run_bounded_maps_seed_v3.py', 'bounded_map_receipts.py', 'bounded_map_worker.py',
    ...
    protocol = {'schema': 'prepared-parent-bounded-maps.v1', 'initial_rank': initial_rank,
