...
import audit_nearcut60v3_mw16_accounting as audit
import certify_compact_r17_candidates as cert
from research_runtime.store import checkpoint
from research_runtime.supervisor import run,Limits
ROOT=audit.ROOT;D=audit.LOCAL/'retained-nearcutoff-mw16-v1/accounting-controller-v3'
...
def prepare():
    ...
    paths=[D.parent/'accounting-schema-correction-v1.json',Path(__file__).resolve(),Path(audit.__file__).resolve(),UPSTREAM/'protocol.json',
           ROOT/'elliptic-curves/cas/report_nearcut60v2_mw16_experiment.py']
...
def launch():
    ...
    try:
        while True:
            ...
            if state=='COMPLETE_FIXED_RETAINED_TRIAL_AND_ACCOUNTING':break
