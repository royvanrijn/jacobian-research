#!/usr/bin/env python3
"""Bounded prepared-seed discovery with exact generic parent subsets and two map policies.
...
def freeze(folder):
    ...
    names = ('run_parent_seed_v3.py', 'visibility_parent_subset.py',
    ...
    protocol = {'schema': 'prepared-parent-subset-adaptive.v3', 'initial_rank': initial_rank,
