...
import time
import shutil
from lean_preconditioned_map_receipts import obtain as obtain_map
...
def freeze(folder):
    ...
    names = ('run_lean_preconditioned_seed_v3.py', 'lean_preconditioned_map_receipts.py', 'lean_preconditioned_map_worker.py',
             'lean_preconditioned_full_pari_mapping.sage',
             'lean_factor_free_pari_mapping.sage', 'visibility_parent_subset.py',
    ...
    protocol = {'schema': 'prepared-parent-lean-preconditioned-maps.v1', 'initial_rank': initial_rank,
