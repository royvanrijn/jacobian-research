...
D=ROOT/'artifacts/local/elliptic-curves/new-rank26-pari-maps-v1'
PARENT=ROOT/'artifacts/local/elliptic-curves/compact-six-r17-h4096-v1/07ca9'
...
def run():
    ...
    for c in previous['centres']:
        ...
        checkpoint(D/'maps.json',output);print('FROZEN NEW RANK26 PARI MAP',len(rows),flush=True)
