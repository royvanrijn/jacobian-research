...
def freeze(folder):
    ...
    require(seed['generic_rank'] == 16 and 16 < initial_rank < 32, 'MW16 seed of rank 17 through 31 required')
    ...
    names = ('run_productive_seed_v3.py', 'visibility_productive92.py',
    ...
    protocol = {'schema': 'prepared-seed-productive-adaptive.v1', 'initial_rank': initial_rank,
        ...
        'scope': 'New directions beyond the supplied certified native MW16 seed. Historical productive '
