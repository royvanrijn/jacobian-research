...
def main():
    ...
    p=batch.protocol();report_path=ART/'nearcut60_mw16_experiment_v1.json'
    audit_path=ART/'nearcut60_mw16_accounting_replay_v1.json'
    ...
    paths={Path(__file__).resolve(),CAS/'verify_nearcut60_mw16_points_portable.py',report_path,audit_path,
    ...
    cert.write(OUT,{'schema':'elliptic-curves.nearcut60-point-evidence.v1','status':'PASS',
    ...
    print('STANDALONE NEARCUT60',len(members),'FILES',archive.stat().st_size,'BYTES',flush=True)
