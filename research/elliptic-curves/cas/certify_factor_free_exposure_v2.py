...
def main(d,protocol,prefix):
 ...
 names=['audit_recorded_point_mod2_rank_v3.py','audit_retained_cloud_modl.py','verify_factor_free_exposure_v2.sage','verify_factor_free_rank.sage','certify_factor_free_exposure_v2.py']
