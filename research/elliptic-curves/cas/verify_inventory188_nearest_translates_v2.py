...
OUT = control.ART/'inventory188_nearest_translate_replay_v2.json'
...
def expected():
    ...
    return {'schema':'elliptic-curves.inventory188-nearest-translates-replay.v1','status':'PASS',
            'sources':{str(path.relative_to(control.ROOT)):control.hashed(path) for path in
                       [control.OUT,control.D/'protocol.json',control.CAS/'verify_inventory188_nearest_translates_v2.py']},
