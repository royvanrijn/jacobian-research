...
DIRECTORY=ROOT/'artifacts/local/elliptic-curves/prospective-mw16-small-conductor-followup-v1'
...
def prepare(directory):
    ...
    checkpoint(directory/'protocol.json',{'schema':'elliptic-curves.prospective-mw16-rank22-followup.v1','sources':sources(),
        ...
        'selection':'The new3/17 rank22 curve has proven exact conductor below all but one listed rank>=22 curve; one further independent point would beat every listed rank>=23 conductor. Use only its certified discovered points.',
