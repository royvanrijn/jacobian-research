...
ROOT=Path(__file__).resolve().parents[2];ART=ROOT/'artifacts/generated-results/elliptic-curves';D=ROOT/'artifacts/local/elliptic-curves/native11952-published-visibility-v2'
PUBLIC=ART/'elliptic_elkies_klagsbrun_rank29_certificate.json';CONTROL=ROOT/'artifacts/local/elliptic-curves/native11952-pari49-control-v1/candidate-00/result.json';CLOUD=ART/'native11952_pari49_recorded_mod2_v1.json';OUT=ART/'native11952_published_visibility_v2.json'
