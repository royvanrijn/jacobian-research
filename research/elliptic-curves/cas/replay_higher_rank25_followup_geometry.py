...
def main():
    ...
    for identifier in IDS:
        ...
        cloud_check(data,seed['charts']+data['charts'],follow.ART/('higher_rank25_'+identifier.replace('-','_')+'_all_retained_mod2_v1.json'),D/'all-retained-point-cloud-only.json')
