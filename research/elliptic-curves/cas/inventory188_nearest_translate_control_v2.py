...
D = ROOT/'artifacts/local/elliptic-curves/inventory188-nearest-translates-v2'
...
OUT = ART/'inventory188_nearest_translate_visibility_v2.json'
...
def sources():
    paths = [PUBLIC, PREVIOUS, OLD, OWN, raw_path(), Path(__file__).resolve(),
             CAS/'run_inventory188_nearest_translates_v2.sage',
             CAS/'verify_inventory188_nearest_translates_v2.py',
