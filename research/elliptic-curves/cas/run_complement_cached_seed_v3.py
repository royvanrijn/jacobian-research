...
import run_complement_seed_v3 as parent
...
def freeze(folder):
    ...
    parent.require(policy['schema'] in ('prepared-parent-complement-boxes.v1',
                                      'prepared-parent-complement-cached.v1'),
    ...
    policy.update(schema='prepared-parent-complement-cached.v1',
...
if __name__ == '__main__':
    ...
    if folder.exists():
        parent.require(parent.read(folder/'protocol.json')['schema'] ==
                       'prepared-parent-complement-cached.v1', 'not a cached continuation')
