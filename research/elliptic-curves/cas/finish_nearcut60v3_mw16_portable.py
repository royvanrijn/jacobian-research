...
ROOT=batch.ROOT;CAS=batch.CAS;D=batch.extension.D/'portable-controller-v3'
...
def prepare():
    ...
    paths=[Path(__file__).resolve(),CAS/'package_nearcut60v3_mw16_points.py',CAS/'verify_nearcut60v2_mw16_points_portable.py',
    ...
    checkpoint(D/'protocol.json',{'sources':{str(p.relative_to(ROOT)):cert.hashed(p) for p in paths},
        ...
        'stages':[['package','package_nearcut60v3_mw16_points.py',300],['isolated-replay','verify_nearcut60v2_mw16_points_portable.py',12000]],
