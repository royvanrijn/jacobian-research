...
"""Export the Sage 10.9 successor replay of the exact level-474 H3 source family.

This preserves a portable current replay with its own hash lineage.  It does not
replace the unavailable historical frozen artifact or its checker.
...
NORMALIZATION = (
    ROOT
    / "artifacts/local/h3-provenance-20260913/elkies-k3-h21-h92-level474-normalization-current-sage109.json"
)
FACTOR = (
    ROOT / "artifacts/local/h3-provenance-20260913/elkies-k3-h21-h92-level474-factor-qq-current-sage109.json"
)
H92 = ROOT / "artifacts/local/humbert-inputs/92/igusa92.txt"
ANCHOR = (
    ROOT / "artifacts/local/h3-provenance-20260913/elkies-k3-h3-noncm-q6-source-anchor-current-sage109.json"
)
H21_DESCENT = (
...
DEFAULT_OUTPUT = (
    ROOT / "artifacts/generated-results/elkies-k3-h3-level474-source-family-sage109-replay.json"
)

EXPECTED_HASHES = {
    NORMALIZATION: "1691d9f0724ad3b8e743a05bc2c1ca00946989d23dc3d2f189ea9b84f5a242ff",
    FACTOR: "030fdc1b3028ad539cec0ad66be9dd5082c3c7a034e96ed972164f3eb2ec073c",
    H92: "427559ecd4c2c19d0a4ed7df1019c8a351ed34f454691e9ef1080a8834e74ea1",
    ANCHOR: "b5a82fd1ec12fef0aebba641867e4fcee45cd858d7fa6d7b7a8e4095551200aa",
...
payload = {
    "schema": "elkies-k3.h3-level474-source-family-sage109-replay.v1",
    "status": "PASS_EXACT_H3_SOURCE_FAMILY_SAGE109_REPLAY",
    "inputs": {
        "normalization": {
...
print("H3SOURCE|status=PASS_EXACT_H3_SOURCE_FAMILY_SAGE109_REPLAY", flush=True)
