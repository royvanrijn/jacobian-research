...
The inversion calculation alone does not prove the stronger sentence:
...
The [later geometric classification](R17_ALTERNATE_Q80_ALL17_PRODUCT_TWIST_CLASSIFICATION_2026-09-04.md)
and [arithmetic regulator closure](R17_PRODUCT_REGULATOR_OBSTRUCTION_SWEEP_2026-09-05.md)
now exclude all seventeen selected product twists at every rational height.
Their anti-invariant and Tate groups are zero. The integral qualification
