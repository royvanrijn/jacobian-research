...
[QUARTIC_WEIGHTED_GEOMETRY.md](../non-elliptic/extended-geometry/QUARTIC_WEIGHTED_GEOMETRY.md).  It imports
...
formal escape path would be the remaining step before calling the whole Quartic Weighted Model
