...
ideal remains open.  The [nonlinear continuation](F2_75_125_NONLINEAR_FORCING.md)
also retains subsequent modular tangent and formal-homotopy checkpoints;
the longest regular jet reaches order 16, but its substitution at `lambda=1`
still leaves 50 nonzero equations.  The linear maps here need not be rebuilt
to rediscover those later results.
