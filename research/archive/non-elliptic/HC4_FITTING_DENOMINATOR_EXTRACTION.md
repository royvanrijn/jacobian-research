...
The [reduced Schur-locus classification](HC4_EXCEPTIONAL_SCHUR_LOCUS.md)
(`HC4QSE4`) is complete in characteristic zero. The remaining obligation here
is the integral torsion module's Fitting ideal, primary thickness and associated
primes; another reduced-support scan does not supply it.
