...
python3 research/scripts/research.py work --area geometry
...
records and source text, including canonical TeX/code and archived Markdown.
`--history` adds preserved cleanup snapshots and inherited work items. Results
...
fails until every current partial result has a fresh review. A normal navigation
check is not evidence that this larger semantic review is complete.
...
ledger, support-saturation gates and curve database directly. For example,
