#!/usr/bin/env python3
"""Independent standard-library audit of both stable normal-form consequences reductions.
...
starts from foundational Keller map, regenerates the 22 stable extensions and the 95-dimensional
...
def main():
    H = regenerate_h()
    print("PASS (stdlib): regenerated the 95D stable cubic-homogeneous form from foundational Keller map")
    audit_linear(H)
