...
from singular_runner import run_singular
...
"""
run_singular(generic_absolute_source, required_markers=("GENERIC_ABSOLUTE_PASS",))
...
"""
run_singular(rank_drop_source, required_markers=("M_RANK_DROP_PASS",))
...
"""
run_singular(special_source, required_markers=("SPECIAL_GENUS_DELTA_PASS",))
...
"""
run_singular(moving_special_source, required_markers=("MOVING_GENUS_DELTA_PASS",))
...
"""
run_singular(moving_absolute_source, required_markers=("MOVING_ABSOLUTE_PASS",))
...
run_singular(
    "\n".join(absolute_lines),
    required_markers=(f"ABSOLUTE_CENSUS={len(height_six)}",),
)
