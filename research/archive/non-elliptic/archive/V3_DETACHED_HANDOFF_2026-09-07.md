...
Historical snapshot: the run subsequently completed. Current results are in
[the canonical V3 note](../elliptic-curves/notes/ADAPTIVE_HALF_LATTICE_V3_2026-09-07.md).
The PID, pending status and operational instructions below are not current.
...
Policy and calibration details: [V3 note](../elliptic-curves/notes/ADAPTIVE_HALF_LATTICE_V3_2026-09-07.md).
Supervisor: [script](../elliptic-curves/cas/run_visibility_v3_detached.sh).
