...
common-linear parity repair does not produce \(k=2\). The subsequent
independent-linear and harmonic-cubic repairs are also closed, as recorded
below. Start further work from the residual charts at the end of this
section; those completed repairs are retained regressions.
