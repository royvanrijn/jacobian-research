...
For the quartic calculation, `WQG1` remains a graph calibration. The exact
open-side principalizations, corner atlas and side-to-corner matches are
already complete (`WQRS1`, `WQCA1`, `WQSM1`; Sections 5.3–5.5). The remaining
assembly starts at the normal-bundle ledger in Section 5.6, with the two
Hilbert-polynomial coefficients and global equinormalization still unknown.
