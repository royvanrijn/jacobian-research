"""Internal ribbon regressions from the now-refuted failed all-k transfer block deformation audit.
...
``verify_all_k_ribbon_functor.py`` for the counterexample.
"""
...
print("NOTICE: these ribbon checks do not imply norm surjectivity onto failed all-k transfer block")
