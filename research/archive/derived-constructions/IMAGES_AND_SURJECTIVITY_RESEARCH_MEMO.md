...
- [fixed-seed omitted-value classifier](../non-elliptic/extended-geometry/OMITTED_VALUE_CLASSIFICATION.md);
- [unique omitted-value lemma](../non-elliptic/extended-geometry/UNIQUE_OMITTED_VALUE.md);
- [contact-atom theorem and phase diagram](../non-elliptic/extended-geometry/CONTACT_ATOM_PRINCIPLE.md);
- [collision closure and irreducibility](../non-elliptic/extended-geometry/COINCIDENT_ROOT_REBUILD.md);
- [explicit component normalizations](../non-elliptic/extended-geometry/COMPONENT_NORMALIZATION.md).
