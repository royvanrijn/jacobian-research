# HC4 before the motion-frame correction

These two snapshots preserve the superseded closure argument. Relative links
...
- [Master reduction](HC4_RELATIVE_NILPOTENT_MASTER_REDUCTION.md.snapshot)
- [Affine-plane bridge](HC4_AFFINE_PLANE_SCHUBERT_BRIDGE.md.snapshot)
