// Complete degree-three residue census for the Q80 genus-one k1 theorem.
#include <array>
#include <algorithm>
#include <cassert>
#include <chrono>
...
int main(int argc,char**argv){
 ...
 int ns;cin>>ns;vector<array<int,3>> signatures(ns);for(auto& sig:signatures){for(int& c:sig)cin>>c;sort(sig.begin(),sig.end());}
 ...
 cout<<"{\"status\":\""<<(visited==749320?"COMPLETE":"BOUNDED_PREVIEW")<<"\",\"orbits\":"<<visited<<",\"smooth_split\":"<<split<<",\"nodal\":"<<nodal<<",\"max_factor_trials\":"<<maxtrials<<",\"zero_norm_rows\":[";
