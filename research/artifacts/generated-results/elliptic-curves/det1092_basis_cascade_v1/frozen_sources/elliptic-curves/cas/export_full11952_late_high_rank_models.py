...
INPUT=ART/'full11952_late64_r17_results_v1.json';OUT=ART/'full11952_late_high_rank_models_v1.json';SAGE=ART/'new_full11952_late_high_rank_curves.sage'

def expected():
    source=cert.read(INPUT);portable=cert.read(ART/'full11952_late64_point_portable_replay_v1.json')
    ...
    paths=[Path(__file__).resolve(),INPUT,ART/'full11952_late64_point_portable_replay_v1.json'];rows=[]
    for r in selected:
...
if __name__=='__main__':
    ...
    print('FULL11952 LATE HIGH-RANK MODELS',[(r['id'],r['rank_lower_bound'],r['minimality']['status']) for r in d['curves']],flush=True)
