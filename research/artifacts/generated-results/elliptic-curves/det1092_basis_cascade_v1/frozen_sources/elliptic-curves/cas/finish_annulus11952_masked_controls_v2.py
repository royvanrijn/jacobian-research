...
def prepare():
    ...
    paths=[Path(__file__).resolve(),Path(control.__file__),CAS/'prepare_annulus11952_masked_controls_v2.sage',CAS/'audit_annulus11952_masked_relations_v2.sage',control.D/'protocol.json',CAS/'research_runtime/supervisor.py',CAS/'research_runtime/store.py']
    jobs=[('maps',control.SAGE,'prepare_annulus11952_masked_controls_v2.sage',[],600),('masked-points',sys.executable,'annulus11952_masked_controls_v2.py',['launch'],1800),('relations',control.SAGE,'audit_annulus11952_masked_relations_v2.sage',[],600),('relations-check',control.SAGE,'audit_annulus11952_masked_relations_v2.sage',['--check'],300)]
