#!/usr/bin/env python3
"""Complete-cloud certificates and recorded coverage of the new27 follow-up."""
from pathlib import Path
import sys,argparse
import certify_compact_r17_candidates as cert
import followup_retention_rank27 as follow
