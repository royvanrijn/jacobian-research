...
import retained_native19_trial as control
...
def main():
    ...
    cloud_check(data,data['charts'],control.ART/('retained_native19_trial_'+control.ROW['id'].split('-')[-1]+'_mod2_v1.json'),D/'result.json')
