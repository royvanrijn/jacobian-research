...
import recent_outer26_followup as control
...
def main():
    ...
    cloud_check(data,data['charts'],control.ART/('recent_outer26_specialized_'+control.ROW['id'].split('-')[-1]+'_mod2_v1.json'),D/'result.json')
