...
ROOT=follow.ROOT;ART=follow.ART;INPUT=ART/'higher24_r17_results_v1.json';OUT=ART/'higher25_followup_results_v1.json'
def sources():
...
def expected():
    old=cert.read(INPUT);follow.configure('11952-069');ledger=cert.read(follow.D/'replay.supervisor.json')
