...
def prepare(index):
    ...
    data['status']='COMPLETE_DECLARED_MAPS';checkpoint(out,data);print('CORRECTED60 MW16 MAPS',row['id'],len(centres),flush=True)
