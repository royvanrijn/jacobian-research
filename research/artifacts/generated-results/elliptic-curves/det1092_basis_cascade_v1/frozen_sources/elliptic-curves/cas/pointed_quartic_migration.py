...
MIGRATED = (
    "elliptic-curves/cas/production_search_gates.py",
...
def runtime_search():
    ...
    return {"backend": pointed.BACKEND_NAME, "coordinate_policy": pointed.CoordinatePolicy().record(),
            ...
            "amendment": "Use PointedQuarticSearch with reusable MWState, shared arithmetic facts and process supervision; finite coordinate boxes change. Candidate and centre selection in these frozen comparators remain governed by the source protocol. Production lazy-centre policies have separate commitments."}
