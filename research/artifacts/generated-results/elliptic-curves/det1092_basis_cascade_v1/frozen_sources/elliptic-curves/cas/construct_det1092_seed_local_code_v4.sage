...
from sage.all import QQ,ZZ,GF,PolynomialRing,EllipticCurve,matrix,pari,prod,lcm
...
DIR = ART/'det1092_seed_local_code_v4'
...
def build(index):
    ...
    x = R.gen()
    den = lcm([tau.denominator(),E.a4().denominator(),E.a6().denominator()])
    assert E.a_invariants()[:3] == (1,1,1)
