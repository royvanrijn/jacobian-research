...
"""Standalone complete finite-group replay of factor-free full point clouds."""
...
def check_one(INPUT):
    ...
    if not points:raise ArithmeticError('nonempty point cloud required')
    projective=[]
    for P in points:
...
if __name__=='__main__':
 ...
 print('PASS independent factor-free full clouds',[(r['point_count'],r['union_finite_rank']) for r in rows])
