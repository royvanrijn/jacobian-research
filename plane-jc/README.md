...
| [JC2_GLOBAL_COX_PACKET_ATTACK.md](JC2_GLOBAL_COX_PACKET_ATTACK.md) | Global quartic Cox and boundary-deletion reduction: raw pole pairs are unbounded and equal numerical matrices can have different residue cancellation; the exact finite Laurent compiler now exhausts every lowering triangular polynomial, including nondecreasing cancellation prefixes, leaving only alternating-direction peak reduction before the invariant degree-four height and conductor-pairing tests |
