...
|---|---|---|---|---|
| C01 | Explicit Keller map and rational collision | Verified independently | [Foundation](verified/FOUNDATIONAL_GEOMETRY.md) | [Lean and exact implementations](verified/LEAN_C01.md); [positive invariance regression](verified/C01_INVARIANCE_REGRESSION.md) |
...
The former transfer programme is preserved only in the
[archive](archive/transfer-program/) and is not part of this ledger.
