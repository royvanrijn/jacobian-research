...
expected = [
    ...
    "Degree-six rank-two symplectic moduli",
    "All-degree rank-two symplectic moduli",
    "Direct `A_2` filtered quantization test",
