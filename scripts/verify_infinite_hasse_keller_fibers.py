...
# composite example is 91 = 7*13; 703 = 19*37 lies in the clean subfamily
# generated by primes 1 modulo 9.
for composite in (91, 703):
    factors = sp.factorint(composite)
    assert composite % 9 == 1
    assert all(prime % 3 == 1 for prime in factors)
