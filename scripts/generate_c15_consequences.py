#!/usr/bin/env python3
"""Generate explicit Dixmier, Hessian-nilpotent, and Image witnesses from C15."""
...
def main():
    ...
    artifact = {
        "format": "c15-explicit-consequences-v1",
        "dixmier_witness": {
            "weyl_dimension": 3,
            ...
            "certificate": ["det JF=1", "delta_i(F_k)=delta_ik", "[delta_i,delta_k]=0", "C01 collision implies Psi is not onto"],
        },
