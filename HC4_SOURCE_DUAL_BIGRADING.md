...
It does not close simultaneous cubic--quartic--sextic corrections, because
the spatial pencil then has half-integral layers and the binary residual
form is no longer isolated by (6.1).
