...
Standard identification $\operatorname{Sym}^3(\P^1)\simeq\P^3$ only for the
intrinsic interpretation, not for the chart isomorphism \\
\addlinespace
...
The four coordinate-change determinants in \eqref{eq:s-t} &
...
Propositions~\ref{prop:pencil-irreducible} and
\ref{prop:universal-disc}; connected transposition graph &
Zariski--Nagata purity; Riemann existence comparison; triviality of finite
etale covers of affine space in characteristic zero \\
\bottomrule
\end{longtable}
\normalsize
