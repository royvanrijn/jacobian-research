...
give distinct stable classes.  In particular, the construction distinguishes
at least $\tau(N-1)$ cross-construction stable classes of degree $N$, each
with a nontrivial fiber.
\end{abstract}
