...
decorated-normalization invariant is generically finite with image dimension
$N-3$; hence weighted degree-$N$ maps contain an $(N-3)$-dimensional family
of stable classes for every $N\ge4$.  Separately, the weighted contact is
