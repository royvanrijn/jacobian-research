...
realized in $\A^3$ with coordinate degree at most $6N+2$.
...
\item identifies the literal map fiber naturally with
      ...
      test algebra $A$.
\end{enumerate}
It also checks that the seed $G(S)=S+S^3$ gives exactly the three coordinates
of the announced map \eqref{eq:announced-counterexample}.
