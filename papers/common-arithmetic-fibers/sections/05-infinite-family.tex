...
The general realization theorem changes the Keller map when $P$ changes.  For
Hasse failures we can do better: one fixed quadratic-gauge map already contains
