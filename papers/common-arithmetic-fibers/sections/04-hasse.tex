...
$\Spec A$ has a point over every completion of $K$ but no $K$-rational point.
Before constructing an example, we show that rank five is the first place
...
\]
Proposition~\ref{prop:gauge} therefore gives
\begin{equation}
