...
\begin{corollary}[Rank classification]\label{cor:rank-classification}
...
\begin{proof}
The identity map realizes rank one.  Theorem~\ref{thm:main} realizes every
finite \'etale algebra of rank at least three, while
Lemma~\ref{lem:degree-two} excludes rank two.
\end{proof}
