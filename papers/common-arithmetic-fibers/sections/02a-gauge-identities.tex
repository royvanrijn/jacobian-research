\subsection{Checking the formula coefficient by coefficient}
\label{subsec:gauge-identities}

The compact formulas in the general localized quadratic-gauge fiber theorem,
Theorem~\ref{thm:localized-gauge}, hide a simple
term-by-term calculation.  We include it here because this is where the map for
an arbitrary degree-$N$ polynomial is assembled.  The argument treats one
generic coefficient $g_k$ at a time; it is not inferred from low-degree
examples.
