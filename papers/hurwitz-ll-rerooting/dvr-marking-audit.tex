...
missing at the time of this audit.  Consequently corrected H2 and coarse H3
are now unconditional over that graph.  The later
\href{../../extended-geometry/RECURSIVE_RESONANCE_ATLAS.md}
{recursive resonance atlas theorem} also constructs the explicit
root-residue flag charts, their contraction maps, and their simultaneous
inertia characters, completing corrected H1.  The conditional language
below is retained as the historical audit of the false root-stable
formulation.
\end{quote}
