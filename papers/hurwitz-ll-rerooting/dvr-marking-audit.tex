...
{recursive resonance atlas theorem} gives explicit root-residue flag
formulas, contraction maps, and simultaneous inertia characters.  Its
selected-factor log-\'etale comparison supplies the global coverage, overlap
descent, and stack identification required for H1-STACK.  The conditional
