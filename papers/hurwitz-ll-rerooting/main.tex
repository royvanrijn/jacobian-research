...
resonance atlas theorem} constructs every source flag divisor by a normalized
initial form in framed residue coordinates, proves contraction descent by
affine composition, and extracts full simultaneous centralizer characters.
Thus corrected H1, H2, and coarse H3 are complete.
\end{quote}
