...
| Normalized linear–quadratic factorization bridge | Proved: the coefficient–resultant map is étale on the coprime locus, the normalized slice is polynomially isomorphic to `A^3`, and multiplication is linearly equivalent to the foundational map | None recorded; exact symbolic checker | [Factorization bridge](verified/NORMALIZED_FACTORIZATION_SLICE.md) |
