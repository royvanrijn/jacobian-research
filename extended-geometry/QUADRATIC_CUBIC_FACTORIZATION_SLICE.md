...
second coefficient chart.  The remaining question is algebraic: whether a
different global modification exists, or whether additive-group invariants
can obstruct even an abstract product isomorphism.
