...
and external review are recorded only
...
| Hurwitz--LL compactification | [LL spectral incidence, marked admissible-cover closure, compactified rerooting groupoid, and exact normalized-Stein/conductor comparison at simultaneous multicluster collisions](HURWITZ_LL_COMPACTIFICATION.md) |
...
| Rank-two descent beyond the explicit line | [Complete degree-five surface, exceptional-chart automorphism group, degree-six fixed-`gamma` surface, all-degree elimination, and direct `A_2` quantization](ALL_DEGREE_RANK_TWO_DESCENT_PROGRAM.md) |
